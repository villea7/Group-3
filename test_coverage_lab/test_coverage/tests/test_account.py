...
# Date: 2026-02-15
# Description: Ensure depositing a positive amount correctly increases the balance.
# ===========================
def test_positive_deposti(setup_account):
    ...
    # Verify the balance has increased by the deposit amount
...
# Author: Alex Villegas
# Date: 2026-02-15
# Description: Ensure depositing zero or negative amount raises a DataValidationError.
# ===========================
def test_invalid_depost(setup_account):
    """Tese depositing zero or negative amount raises an error"""
    account = setup_account
